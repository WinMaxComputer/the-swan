...
<div class="row">
  <div class="col-md-12">
    <div class="card ">
      ...
      <div class="card-body">
        <form action="{{ route('pages.activity') }}" method="GET" class="mb-4">
          <div class="row">
            <div class="col-md-4">
              <div class="input-group">
                <input type="text" name="search" class="form-control text-white" placeholder="Search activities..." value="{{ request('search') }}">
            ...
            @if(request('search') || request('perPage') || request('lang'))
              <div class="col-md-2">
                <a href="{{ route('pages.activity') }}" class="btn btn-secondary btn-sm mt-1">Clear</a>
              </div>
            @endif
          </div>
        </form>
        ...
        <div class="table-responsive">
          <table class="table tablesorter " id="">
            ...
            @empty
              <tr>
                <td colspan="7" class="text-center text-muted py-5">No activities found matching your criteria.</td>
              </tr>
            @endforelse  
            </tbody>
          </table>
